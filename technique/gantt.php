...
<html lang="fr">
    <head>
        <title>SAE 24 - Diagramme de GANTT</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <section class="contenu">
            <h1 class="titre">Diagramme de GANTT previsonnel et final</h1>
            <article class="texte">
                <h3>Validation HTML</h3>
                <p>Le diagramme de GANTT prévisionnel à été respecté dans les délais impartis</p>
                <img class="validation" src="../livrables/Gantt.PNG" alt="Diagramme de gantt  ">
            </article>
        </section>
    </body>
</html>
